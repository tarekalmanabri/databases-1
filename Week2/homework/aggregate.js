...
const queries = [
  ...
  "SELECT *, COUNT(author_no) FROM Research_Papers GROUP BY Research_Papers.paper_id",

  // Sum of the research papers published by all female authors.
  "SELECT count(*)  FROM Research_Papers join Authors ON Authors.author_no = Research_Papers.author_no WHERE Authors.gender = 'f'",
